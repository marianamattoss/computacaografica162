...
void ObjectDescriptor::store(string name,  GeometricElementType type, vector<Coordinate> coords) {
	...
	if(type == GeometricElementType::point) {
		...
		if(type == GeometricElementType::polygon) {
...
vector<GeometricElement*> ObjectDescriptor::parse(string filePath) {
	ifstream file(filePath);
	string objectName;
	vector<Coordinate> vertices;
	vector<GeometricElement*> newDisplayFile;
